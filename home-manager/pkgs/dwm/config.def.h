...
static const char *fonts[]          = {"FiraCode Nerd Font:size=10:weight=bold:antialias=true", "Symbols Nerd Font:pixelsize=12:autohint:true" };
...
static const Key keys[] = {
	...
	{ 0, 				XK_F3,	spawn,		SHCMD("brightnessctl set 10%+ ; pkill -RTMIN+1 dwmblocks") },
    { 0, 				XK_F2,	spawn,		SHCMD("brightnessctl set 10%- ; pkill -RTMIN+1 dwmblocks") },
